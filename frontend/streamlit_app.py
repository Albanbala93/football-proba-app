...
# API-Football season identifier (2026 = saison 2026-2027). A bump ici doit
# accompagner le --season transmis a .github/workflows/refresh-ligue1-api-football.yml.
LIGUE1_API_XG_SEASON = "2026"
LIGUE1_API_XG_FEATURES_PATH = PROJECT_ROOT / "data" / "processed" / f"api_football_ligue1_{LIGUE1_API_XG_SEASON}_prematch_features.csv"
LIGUE1_API_XG_FORMATION_FEATURES_PATH = PROJECT_ROOT / "data" / "processed" / f"api_football_ligue1_{LIGUE1_API_XG_SEASON}_formation_performance_features.csv"
LIGUE1_API_XG_INJURY_FEATURES_PATH = PROJECT_ROOT / "data" / "processed" / f"api_football_ligue1_{LIGUE1_API_XG_SEASON}_injury_impact_features.csv"
LIGUE1_API_XG_MATCH_STAKES_PATH = PROJECT_ROOT / "data" / "processed" / f"api_football_ligue1_{LIGUE1_API_XG_SEASON}_match_stakes_features.csv"
LIGUE1_API_XG_LINEUP_STRENGTH_PATH = PROJECT_ROOT / "data" / "processed" / f"api_football_ligue1_{LIGUE1_API_XG_SEASON}_lineup_strength_features.csv"
